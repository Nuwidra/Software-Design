...
public final class JsonPlaceholderExternalPostService implements ExternalPostService {
    ...
    @Autowired
    public JsonPlaceholderExternalPostService(final @Value("${blog.externalservice.jsonplaceholder.url}")String baseUrl,
    ...
    public List<Post> pull() {
        final List<ExternalPostDTO> externalPostDTOS = getExternalPostsDTOS();
        return convertPostsDTOS(externalPostDTOS);
    }

    private List<ExternalPostDTO> getExternalPostsDTOS() {
    ...
    private List<Post> convertPostsDTOS(List<ExternalPostDTO> externalPostDTOS) {
        return externalPostDTOS.stream()
