...
public final class CountingBoard implements Board, BoardState {
    ...
    @Override
    public Optional<Token> getPosition(Pair<Row, Column> move) {
        return Optional.ofNullable(this.board.get(move));
    }

    @Override
    public boolean isFull() {
        return this.board.size() == BOARD_COLUMN_COUNT * BOARD_COLUMN_COUNT;
    }
